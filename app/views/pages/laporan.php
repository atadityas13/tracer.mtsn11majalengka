...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'transkrip' || $action === 'bulk_transkrip') {
        ...
        // Kelompok B (Kelompok B dan Muatan Lokal dipisah)
        $mapelsB = [];
        $mulokB = [];
        foreach ($dbMapelList as $dm) {
            if ($dm['kelompok'] === 'B') {
                // Jika mengandung kata "Muatan Lokal" atau "Bahasa Daerah / Sunda / Mulok" kita bisa pisahkan ke Mulok jika perlu, 
                // namun cara paling aman adalah memeriksa nama mapel. Di madrasah, Bahasa Sunda / Muatan Lokal masuk Mulok.
